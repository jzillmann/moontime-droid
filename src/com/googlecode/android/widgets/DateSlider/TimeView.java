...
/**
 * This interface represents the views that will settle the ScrollLayout. Each
 * element has to deal with its label via the setText method and needs to
 * contain the start and end time of the element. Moreover this interface
 * contains three implementations one simple TextView, A two-row LinearLayout
 * and a LinearLayout which colors Sundays red.
 * 
 */
public interface TimeView {
  ...
  /**
   * This is a simple implementation of a TimeView which realised through a
   * TextView.
   * 
   */
  ...
  /**
   * This is a more complex implementation of the TimeView consisting of a
   * LinearLayout with two TimeViews.
   * 
   */
  public static class TimeLayoutView extends LinearLayout implements TimeView {
     ...
     *          LineHeight of the top TextView
     */
    protected void setupView(Context context, boolean isCenterView, int topTextSize, int bottomTextSize,
        float lineHeight) {
  ...
  /**
   * More complex implementation of the TimeView which is based on the
   * TimeLayoutView. Sundays are colored red in here.
   * 
   */
  public static class DayTimeLayoutView extends TimeLayoutView {
     ...
     *          LineHeight of the top TextView
     */
    public DayTimeLayoutView(Context context, boolean isCenterView, int topTextSize, int bottomTextSize,
        float lineHeight) {
