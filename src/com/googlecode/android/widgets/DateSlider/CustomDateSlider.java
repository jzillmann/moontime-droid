...
public class CustomDateSlider extends DateSlider {
  ...
  /**
   * Create the year and the week and day of the week scrollers and feed them
   * with their labelers and place them on the layout.
   */
  @Override
  ...
  /**
   * Here we define our Custom TimeTextView which will display the fonts in its
   * very own way.
   */
